...
ArrayAccess:
    ...
    Quadruple* q= new Quadruple(string("*int "),  append_scope_level($3->varName), to_string(4),  resName );
    $$->code.push_back(q);
    ircode.push_back(q);
