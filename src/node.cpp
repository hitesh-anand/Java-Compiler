...
vector<Quadruple*> ircode;
    ...
    Node::Node(string label, string attr, vector<struct Node*> children)
    {
        ...
        for(auto it: children) {
            if(it->code.size() > 0) this->code.insert(this->code.end(), it->code.begin(), it->code.end());
    ...
    void Node::addChild(struct Node* n)
    {
        ...
        if(n->code.size() > 0) this->code.insert(this->code.end(), n->code.begin(), n->code.end());
    ...
    void Node::addChildToLeft(struct Node* n)
    {
        ...
        this->children[0] = n;
        if(n->code.size() > 0 ) {n->code.insert(n->code.end(),this->code.begin(), this->code.end());
        this->code =n->code;}
